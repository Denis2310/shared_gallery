...
class Validator
{
    public static function validateRegistration($username, $email, $password, $password_confirmation)
    {
        $message = '';
    ...
    public static function validatePasswordEdit($password, $confirm_password)
    {
        $message = '';
        $password = trim($password);
